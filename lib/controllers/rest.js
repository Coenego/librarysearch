...
var getRESTSearchResults = exports.getRESTSearchResults = function(req, res) {
    ...
    if (req.params.query) {
        ...
        AquabrowserAPI.getAquabrowserResults(query, params, function(err, _res) {
            ...
            if (searchComplete === searchToComplete) {
                res.send(200, {'params': params, 'results': results});
            }
        });
        
        // Get Summon results
        SummonAPI.getSummonResults(query, params, function(err, _res) {
