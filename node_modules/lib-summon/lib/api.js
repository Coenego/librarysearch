 ...
 */
var getSummonResults = module.exports.getSummonResults = function(query, params, callback) {

    // Check if extra parameters are added
    if (params) {
        if (params.type) {
            console.log('getSummonResults');
            var type = config.constants.types[params.type]['summon'];
            console.log(type);
        }
    }
    ...
    var queryString = ['s.ff=ContentType,or,Journal:eJournal,5', 's.q=Darwin'];
